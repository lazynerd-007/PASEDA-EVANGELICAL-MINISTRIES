      ...
      <div className="container mx-auto max-w-4xl px-4 text-center">
        ...
        <div className="mb-12 space-y-6 text-lg leading-relaxed text-neutral-600">
          <p>
            ...
            personally involved in the end-time harvest in a meaningful way? Mega
            Harvest Partnership Program puts you on the front line of global
            evangelism. The ministry partnership program is a practical and
            highly effective initiative that reaches thousands of precious souls
            face to face and millions via television with the gospel of Jesus
            Christ every year. We are on a mission to announce Jesus to all
            nations until He is Believed throughout the world.
          </p>
